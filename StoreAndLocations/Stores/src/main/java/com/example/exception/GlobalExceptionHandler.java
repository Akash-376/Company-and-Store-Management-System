...
public class GlobalExceptionHandler {
	...
	/**
     * Handles exceptions of type `ResourceFoundException` by returning error details.
     *
	...
	public ResponseEntity<MyErrorDetails> batteryNotFound(ResourceNotFoundException e, WebRequest req){
